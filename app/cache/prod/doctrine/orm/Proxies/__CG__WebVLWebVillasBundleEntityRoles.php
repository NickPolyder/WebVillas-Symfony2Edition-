 ...
 */
class Roles extends \WebVL\WebVillasBundle\Entity\Roles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Roles' . "\0" . 'name', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Roles' . "\0" . 'role', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Roles' . "\0" . 'id', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Roles' . "\0" . 'users');
        }
