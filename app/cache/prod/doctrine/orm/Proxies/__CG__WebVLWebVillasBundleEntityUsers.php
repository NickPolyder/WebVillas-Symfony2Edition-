 ...
 */
class Users extends \WebVL\WebVillasBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'username', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'password', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'salt', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'email', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'theme', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'activated', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'activationCode', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'joined', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'id', '' . "\0" . 'WebVL\\WebVillasBundle\\Entity\\Users' . "\0" . 'roles');
        }
    ...
    public function setActivationCode($activationCode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setActivationCode', array($activationCode));
